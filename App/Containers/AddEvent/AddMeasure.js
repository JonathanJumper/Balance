...
class AddMeasure extends Component {
   ...
   render() {
      const { navigate } = this.props.navigation
      let message = (this.state.typeOfEvent == 1 || this.state.typeOfEvent == 4) ? "Tu nivel recomendado de insulina a aplicar es de " + this.props.calculatedInsuline + ". Desea registrar un valor de: " : "No se realizo el calculo de carbohidratos. Desea registrar un valor de: "
      return (
